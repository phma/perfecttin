...
void testclosest()
{
  ...
  /* These segments and points are from drawing contours.
   * They put the program in an outer-space loop.
   * 0 is the slowest; 3 and 5 are the fastest.
   */
  segment seg0(xyz(686339.95627360709,539653.93380936189,0),xyz(686338.24567352049,539652.00012038834,0));
  xy pnt0(686339.9020066011,539653.87258876674);
  segment seg1(xyz(686487.73981688323,539729.40513351117,0),xyz(686488.30453954497,539730.83334711136,0));
  xy pnt1(686487.74753882142,539729.42426621623);
  segment seg2(xyz(686487.61331164197,539784.30438238196,0),xyz(686485.97758835182,539781.61238190439,0));
  xy pnt2(686487.34583457687,539783.86408202758);
  segment seg3(xyz(686226.93349632376,539618.50801790471,0),xyz(686226.26653894747,539620.31474612083,0));
  xy pnt3(686226.81885519472,539618.81849456544);
  segment seg4(xyz(686649.66148500924,539617.52786555106,0),xyz(686647.81320575438,539615.76647709392,0));
  xy pnt4(686648.16777634376,539616.10387181852);
  segment seg5(xyz(686662.25929891376,539583.3405907579,0),xyz(686662.25747782015,539583.15408039524,0));
  xy pnt5(686662.2597993454,539583.30841254722);
  segment seg6(xyz(686308.91717555583,539526.29069842689,0),xyz(686309.14847578201,539525.9486539918,0));
  xy pnt6(686308.96180704795,539526.22567611735);
  PostScript ps;
  net.clear();
  cloud.clear();
  aster(1000);
